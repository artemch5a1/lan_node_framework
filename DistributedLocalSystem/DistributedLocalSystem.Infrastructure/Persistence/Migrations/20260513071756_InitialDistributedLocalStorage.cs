...
namespace DistributedLocalSystem.Infrastructure.Persistence.Migrations
{
    ...
    public partial class InitialDistributedLocalStorage : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InstanceSlug = table.Column<string>(
                        type: "TEXT",
                        maxLength: 48,
                        nullable: false
                    ),
                    InstanceGuid = table.Column<string>(
                        type: "TEXT",
                        maxLength: 64,
                        nullable: false
                    ),
                    RemoteHostIp = table.Column<string>(
                        type: "TEXT",
                        maxLength: 45,
                        nullable: true
                    ),
        ...
        {
            migrationBuilder.DropTable(name: "net_discovery_settings");
        }
    }
}
